(function() {
  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    var uniqes = new Set(array);
    var results = [];
    uniqes.forEach((element)=>{
      if (!currentBoolean.hasOwnProperty(iterator(element))) {
        results.push(element);
        currentBoolean[iterator(element)] = iterator(element);
      }
    });
  ...
  _.shuffle = function(array) {
    ...
    while (arrCopy.length ){
      var randomIndex = Math.floor(Math.random() * arrCopy.length);  //how we pick our index
      randomArr.push(arrCopy[randomIndex]);
  ...
  _.invoke = function(collection, functionOrKey, args) {
    return _.map(collection, function(element, i) {
      functionOrKey = element[functionOrKey] || functionOrKey;
